...
type ServerInterface interface {
	...
	// (POST /users/image/{user_id})
	SetUserImage(w http.ResponseWriter, r *http.Request)
}
...
// (POST /users/{id})
func (_ Unimplemented) SetUserImage(w http.ResponseWriter, r *http.Request, id int64) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) GetUser(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "user_id", chi.URLParam(r, "user_id"), &user_id, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
// SetUserImage operation middleware
func (siw *ServerInterfaceWrapper) SetUserImage(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Patch(options.BaseURL+"/users/update/{user_id}", wrapper.UpdateUser)
	})
	r.Group(func(r chi.Router) {
		r.Patch(options.BaseURL+"/users/image/{user_id}", wrapper.SetUserImage)
	})
